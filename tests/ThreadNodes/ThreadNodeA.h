...
namespace TSML::Test
{
    class ThreadNodeA : public ThreadNode<TestThreadMessages, TestExceptionType>
    {
    public:
        explicit ThreadNodeA(TSMLContext<TestThreadMessages> *context ,std::string node_id) :
